...
<html lang="en">
    <head>
        ...
        <title>Register | Real Estate Property Management</title>
                            ...
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-4">
                                    <div class="card-header">
                                        <h3 class="text-center font-weight-light " style="margin-top: 10px;"><img src="{{ asset('images/logo_prop.png') }}" style="height: 70px;"></h3>
                                    </div>
                                    <div class="card-body loginform">
                                        ...
                                        <form action="javascript:void(0);" id="register" class="" method="post" name="login" autocomplete="off" style="margin-top: 15px;">
                                            <div class="form-group mb0">
                                                <label class="small mb-1" for="f_name">Full Name</label>
                                                <input class="form-control fs12" name="f_name" id="f_name" type="text" placeholder="Enter Fullname" onkeypress="removeError()" />
                                            ...
                                            <div class="form-group mb0">
                                                <label class="small mb-1" for="u_type">User type</label>
                                    ...
                                    <div class="card-footer text-center">
                                        <div class="small" style="color: gray"> Already have an account? <a href="{{url('/login')}}">Login</a></div>
                                    </div>
                                </div>
                            </div>
        ...
        <script>
            ...
            function register() {
                $("#register").submit(function(event) {
                    ...
                    if(fname == '') {
                        $('#err_f_name').html('Fullname is required.');
